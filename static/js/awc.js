...
class HComponent extends HLinkedList{
    ...
    setDataRole(role){
        this.domElement.setAttribute("data-role", role);
        return this
    }
    setDataRel(){
        this.domElement.setAttribute("data-rel", "popup");
        return this
    }
    setAsDialog(){
        this.domElement.setAttribute("data-rel", "dialog");
        return this
    }
    setAria(boolean){
        this.domElement.setAttribute("aria-hidden", boolean);
        return this;

    }
    setRole(role){
        this.domElement.setAttribute("aria-hidden", role);
        return this;
...
let DropDown = function (id, name=''){ return new HDropDown(id,name)};
